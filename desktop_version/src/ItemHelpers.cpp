...
void registerItems(void)
{
    ...
    Items::FRESHWATER_BUCKET = registerItem("freshwater_bucket", new FilledBucketItem(ItemSettings().withName("Bucket (Filled)").withDescription("It's a bucket. You cannot wear it on your head.").withLayer("bucket", 303).withLayer("bucket_fill",304)));
    Items::SALTWATER_BUCKET = registerItem("saltwater_bucket", new FilledBucketItem(ItemSettings().withName("Bucket (Filled)").withDescription("It's a bucket. You cannot wear it on your head.").withLayer("bucket", 303).withLayer("bucket_fill",305)));
    Items::JUNKWATER_BUCKET = registerItem("junkwater_bucket", new FilledBucketItem(ItemSettings().withName("Bucket (Filled)").withDescription("It's a bucket. You cannot wear it on your head.").withLayer("bucket", 303).withLayer("bucket_fill",306)));
    Items::GREENWATER_BUCKET = registerItem("greenwater_bucket", new FilledBucketItem(ItemSettings().withName("Bucket (Filled)").withDescription("It's a bucket. You cannot wear it on your head.").withLayer("bucket", 303).withLayer("bucket_fill",307)));
    Items::BLUEWATER_BUCKET = registerItem("bluewater_bucket", new FilledBucketItem(ItemSettings().withName("Bucket (Filled)").withDescription("It's a bucket. You cannot wear it on your head.").withLayer("bucket", 303).withLayer("bucket_fill",308)));
    Items::PURPLEWATER_BUCKET = registerItem("purplewater_bucket", new FilledBucketItem(ItemSettings().withName("Bucket (Filled)").withDescription("It's a bucket. You cannot wear it on your head.").withLayer("bucket", 303).withLayer("bucket_fill",309)));
